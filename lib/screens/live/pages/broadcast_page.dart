...
import 'package:kuick_clone/screens/live/pages/messaging.dart';
import 'package:kuick_clone/utils/agoraID.dart';
    ...
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => RealTimeMessaging(
          ...
          isBroadcaster: widget.isBroadcaster, key: widget.key!,
        ),)
    );
  }
}
